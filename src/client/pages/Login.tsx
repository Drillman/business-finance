...
import { Fingerprint, ShieldCheck, Receipt, TrendingUp } from 'lucide-react'
import { Alert, Button, Input } from '@drillman/dashboard-ui'
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="grid min-h-screen w-full lg:grid-cols-2">
        <aside className="relative hidden overflow-hidden bg-linear-225 from-accent-strong via-info to-[#6366F1] px-15 pb-14.5 pt-17.5 text-white lg:block">
          ...
          <div className="absolute left-15 top-45 flex h-16 w-60 -rotate-2 items-center gap-3 rounded-card border border-white/20 bg-white/10 px-4 backdrop-blur-md">
          ...
          <div className="absolute left-95 top-80 flex h-16 w-55 rotate-3 items-center gap-3 rounded-card border border-white/20 bg-white/10 px-4 backdrop-blur-md">
          ...
          <div className="absolute left-35 top-115 flex h-16 w-50 -rotate-1 items-center gap-3 rounded-card border border-white/20 bg-white/10 px-4 backdrop-blur-md">
          ...
          <div className="absolute bottom-15 left-15 flex items-center gap-2.5">
            ...
            <p className="text-kpi-sm font-bold text-white">Finances</p>
          </div>
        </aside>
        ...
        <main className="flex items-center justify-center px-6 py-10 sm:px-8">
          <div className="w-full max-w-95 space-y-6 py-8">
            <div className="flex items-center justify-center gap-3">
              ...
              <p className="text-2xl font-bold text-text-primary">Finances</p>
            </div>

            <p className="text-center text-sm text-text-secondary">Connectez-vous a votre compte</p>
              ...
              <>
                {shouldShowSeparator && (
                  <div className="flex w-full items-center gap-3">
                    ...
                    <span className="text-compact text-text-muted">ou</span>
                    <div className="h-px flex-1 bg-border" />
                  </div>
                )}
            ...
            {shouldShowSignup && (
              <div className="pt-1 text-center text-sm text-text-secondary">
